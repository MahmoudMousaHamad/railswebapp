...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { about: @publisher.about, books_id: @publisher.books_id, journals_id: @publisher.journals_id, name: @publisher.name, website: @publisher.website } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { about: @publisher.about, books_id: @publisher.books_id, journals_id: @publisher.journals_id, name: @publisher.name, website: @publisher.website } }
